...
public class HttpResponseHelper {
    public static void sendAudioFile(HttpServletResponse response, String filePath) throws IOException {
    ...
    public static void sendBinaryData(HttpServletResponse response, String filePath) throws IOException {
        byte[] bytes = ResourceFileUtils.getBytes(filePath);
        sendBinaryData(response, bytes);
    }
